		...
		return (
			<div className="max-w-lg mx-auto text-center">
				...
				<div className="bg-paper dark:bg-night-paper border border-ai-line dark:border-night-line rounded-lg shadow-card dark:shadow-none p-6">
					...
					<button
						onClick={goToSetup}
						className="font-bengali text-sm border border-ai-line dark:border-night-line text-ai dark:text-ai-glow rounded-md py-2 px-6 hover:bg-ai-soft dark:hover:bg-night-line"
					>
						{T("quizSetupTitle")}
					</button>
				</div>
